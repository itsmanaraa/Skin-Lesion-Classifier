...
def build_transforms(img_size=224, train=True):
    ...
    if train:
        return transforms.Compose([
            ...
            transforms.RandomVerticalFlip(p=0.5),  # Added: Lesions have no orientation
            transforms.RandomAffine(degrees=15, translate=(0.1, 0.1), scale=(0.9, 1.1)), # Added: Scale/Shift
